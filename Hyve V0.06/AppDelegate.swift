...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "HYV3_BUBBASQUID1995"
            ParseMutableClientConfiguration.clientKey = "BUBBYSQUAD1995"
            ParseMutableClientConfiguration.server = "http://hyv3moja.herokuapp.com/parse"
        })
        ...
        // If you would like all objects to be private by default, remove these 2 lines.
        ...
        // Check if currentUser is signed in
        // If yes - Initial VC is mainJobVC
        // If no - Initial VC is loginVC
        //        self.window = UIWindow(frame: UIScreen.mainScreen().bounds)
        //        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        //
        //        var initialViewController = storyboard.instantiateViewControllerWithIdentifier("mainJobVC")
        //
